...
export const translations = {
  de: {
    ...
    hero: {
      ...
      description:
        "Starte deinen Minecraft Server mit nur einem Befehl. Quickpaper macht Server-Setup so einfach wie nie zuvor – interaktiv oder vollautomatisch.",
      cta: "Jetzt starten",
    ...
    features: {
      ...
      subtitle:
        "Alles was du brauchst, um deinen perfekten Minecraft Server zu starten",
      oneCommand: {
        title: "Ein Befehl",
        description:
          "Kein kompliziertes Setup mehr. Ein einziger Befehl und dein Server läuft.",
      },
      interactive: {
        title: "Interaktiver Modus",
        description:
          "Wähle Version, Speicher und Einstellungen in einem geführten Setup-Prozess.",
      },
      fast: {
        title: "Blitzschnell",
        description:
          "Optimiert für Geschwindigkeit. Dein Server startet in weniger als 60 Sekunden.",
      },
      papermc: {
        title: "PaperMC Integration",
        description:
          "Automatischer Download der neuesten Paper-Version mit optimaler Konfiguration.",
      },
      plugins: {
    ...
    installation: {
      ...
      interactive: {
        title: "Interaktiver Modus",
        description:
          "Perfekt für Einsteiger. Werde durch alle Optionen geführt.",
        command: "curl -fsSL https://quickpaper.nicompter.de/install | bash",
      },
      quick: {
        title: "Schnellstart",
        description:
          "Für Profis. Standardeinstellungen mit automatischen Updates auf die neueste Paper-Version.",
        command:
      ...
      custom: {
        ...
        description:
          "Volle Kontrolle über alle Parameter mit Auto-Update auf die neueste Version.",
        command:
    ...
    cta: {
      ...
      description:
        "Starte jetzt in weniger als einer Minute. Kostenlos und Open Source.",
  ...
  en: {
    ...
    hero: {
      ...
      description:
        "Launch your Minecraft server with just one command. Quickpaper makes server setup easier than ever – interactive or fully automated.",
      cta: "Get Started",
    ...
    features: {
      ...
      oneCommand: {
        title: "One Command",
        description:
          "No more complicated setup. Just one command and your server is running.",
      },
      interactive: {
        title: "Interactive Mode",
        description:
          "Choose version, memory and settings in a guided setup process.",
      },
      fast: {
        title: "Lightning Fast",
        description:
          "Optimized for speed. Your server starts in less than 60 seconds.",
      },
      papermc: {
        title: "PaperMC Integration",
        description:
          "Automatic download of the latest Paper version with optimal configuration.",
      },
      plugins: {
        title: "Plugin Support",
    ...
    installation: {
      ...
      quick: {
        title: "Quick Start",
        description:
          "For pros. Default settings with automatic updates to the latest Paper version.",
        command:
          "curl -fsSL https://quickpaper.nicompter.de/install | bash -s -- --non-interactive --yes --accept-eula --auto-update",
      },
      custom: {
        title: "Custom",
        description:
          "Full control over all parameters with auto-update to the latest version.",
        command:
          "curl -fsSL https://quickpaper.nicompter.de/install | bash -s -- --version 1.21.4 --min-ram 2G --max-ram 4G --port 25565 --accept-eula --auto-update",
      },
    },
